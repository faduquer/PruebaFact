...
namespace PruebaFact.Controllers
{
    public class BaseController : Controller
    {
        public void Alert(string message, NotificationType notificationType)
        {
            ...
            var msg = "<script language='javascript'>Swal.fire({title:'',text: '" + message + "',icon:'" + notificationType + "',allowOutsideClick: false,allowEscapeKey: false,allowEnterKey: false})" + "</script>";
